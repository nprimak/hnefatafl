...
<?php
  $p1nickname = $_GET["p1nickname"];
  $p2nickname = $_GET["p2nickname"];
  $p2avatar = $_GET["p2avatar"];
  $p1avatar = $_GET["p1avatar"];

    if($p1nickname == null || $p2nickname == null){
    ...
    <div id="container">
        ...
        <div id="canvas-container">
            ...
            <div id="player1" class="sidebar">
                <h2>Player One</h2> 
                <div class="avatar">
                    <img src="../images/avatars/<?php echo $p1avatar; ?>.png">
                    <p><?php echo $p1nickname; ?></p>
                </div>
                <p>Black</p>
            ...
            <div id="player2" class="sidebar">
                <h2>Player Two</h2>
                <div class="avatar">
                    <img src="../images/avatars/<?php echo $p2avatar; ?>.png">
                    <p><?php echo $p2nickname; ?></p>
                </div>
                <p>White</p>
                <div class="update"></div>
            </div>
